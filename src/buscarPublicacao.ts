...
interface BuscarPublicacaoParams {
  termo: string;
  filtro?: string;
}

async function buscarPublicacao(params: BuscarPublicacaoParams): Promise<void> {
  try {
    ...
    console.log(`Executando buscarPublicacao com termo=${params.termo}...`);
    ...
    const resultado = {
      ...
      status: "sucesso",
      mensagem: "Busca publicações no Diário Oficial concluído com sucesso",
      resultado: {
...
export default buscarPublicacao;
